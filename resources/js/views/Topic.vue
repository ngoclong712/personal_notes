            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                ...
                <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-800">
                    <tr v-for="topic in topics" :key="topic.id" class="hover:bg-gray-50 dark:hover:bg-gray-800">
                        ...
                        <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">{{ topic.description }}</td>
                    ...
                    <tr v-if="topics.length === 0">
                        <td colspan="3" class="px-4 py-6 text-center text-sm text-gray-500 dark:text-gray-400">No topics found.</td>
                    </tr>
                </tbody>
            </table>
        </div>
